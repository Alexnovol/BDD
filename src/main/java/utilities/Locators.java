...
public class Locators {
    ...
    public final static String XPATH_FILTER_DIAGONAL = "//*[@class='filters-desktop__item j-filter-container filters-desktop__item--type-1 filters-desktop__item--f4474 open show']//*[text()='insert diagonal']/preceding-sibling::span";

    public final static String XPATH_FILTER_BRAND = "//*[@class='filters-desktop__item j-filter-container filters-desktop__item--type-6 filters-desktop__item--fbrand open show']//*[text()='insert brand']/preceding-sibling::span";
    ...
    public final static String XPATH_CART_BUTTON = "//*[@class='navbar-pc__item j-item-basket']/a";

    public final static String CLASS_COUNT_PRODUCTS_CART = ".navbar-pc__notify";

    public final static String XPATH_IN_CART_BUTTON = ".//*[@href='/lk/basket']";
    ...
    public final static String XPATH_ANY_DELIVERY_POINT = "//*[@id='pooList']//*[contains(text(), 'city')]";
